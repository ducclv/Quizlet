...
class FoldersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'creator' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '0', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-07-04 02:24:16',
                'modified' => '2020-07-04 02:24:16',
            ],
        ];
        parent::init();
    }
